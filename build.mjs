...
const ASSETS = {
  ...
  combatDirections: ['assets/hd/runtime/traveler-combat-directions-atlas.png', 'image/png'],
  ...
  trees: ['assets/hd/runtime/vegetation-trees-atlas.png', 'image/png'],
  vegetation: ['assets/hd/runtime/vegetation-ground-atlas.png', 'image/png'],
  stumps: ['assets/hd/runtime/vegetation-stumps-atlas.png', 'image/png'],
